document.addEventListener('DOMContentLoaded', function() {
    ...
    //     showAlert('Thank you for your message! We will get back to you soon.', 'success', this);
    //     this.reset();
    // });
    ...
    // Remove or comment out the existing contact form submission handler
    // and replace it with this simplified version:

    contactForm.addEventListener('submit', function(e) {
        // Formsubmit will handle the submission, so we just need basic validation
        const name = document.getElementById('name').value.trim();
        const email = document.getElementById('email').value.trim();
        const message = document.getElementById('message').value.trim();
